...
while cap.isOpened():
    ...
    for result in results:
        if hasattr(result, "boxes"):
            ...
            masks = result.masks.xy if hasattr(result, "masks") and result.masks is not None else None # get masks
            ...
            for i in range(len(boxes)):
                if int(classes[i]) == BIRD_CLASS_ID:
                    ...
                    if masks is not None:
                        ...
                        cv2.polylines(frame, [mask], isClosed=True, color=(255, 0, 255), thickness=2)  # Draw polygon mask
    ...
    for track in tracked_objects:
        ...
        # Calculate the center of the bounding box for the trajectory
